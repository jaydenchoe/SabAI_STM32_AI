...
#define AI_NETWORK_IN_1_SIZE  (90 * 3 * 1)
#define AI_NETWORK_IN_1_SIZE_BYTES  ((90 * 3 * 1) * 4)
...
#define AI_NETWORK_OUT_1_SIZE  (1 * 1 * 3)
#define AI_NETWORK_OUT_1_SIZE_BYTES  ((1 * 1 * 3) * 4)
