...
1) 보드를 팔에 부착합니다. 긴 케이블이 필요합니다. 정확히 부착하는 위치와 방향은 알려드릴께요.
2) 먼저 특정 운동의 시작 포지션으로 팔을 움직여 놓은 상태에서, 가족 등 주변에 다른 분 도움을 받는게 편합니다.
3) MAC 기준으로 $ script output.txt 를 입력하고 엔터를 치세요.
4) MAC 기준으로 $ screen ${DEVICENAME} 115200를 입력하고  
2) 먼저 특정 운동의 시작 포지션으로 팔을 움직여 놓은 생태에서,주변에 다른 분 도움을 받는게 편합니다
2) 먼저 특정 운동의 시작 포지션으로 팔을 움직여 놓은 생태에서,주변에 다른 분 도움을 받는게 편합니다.
