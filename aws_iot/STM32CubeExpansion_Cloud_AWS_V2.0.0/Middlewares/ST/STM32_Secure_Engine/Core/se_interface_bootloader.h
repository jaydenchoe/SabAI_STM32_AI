...
SE_ErrorStatus SE_SFU_IMG_GetActiveFwState(SE_StatusTypeDef *peSE_Status, SE_FwStateTypeDef *p_FwState);
SE_ErrorStatus SE_SFU_IMG_SetActiveFwState(SE_StatusTypeDef *peSE_Status, SE_FwStateTypeDef *p_FwState);
