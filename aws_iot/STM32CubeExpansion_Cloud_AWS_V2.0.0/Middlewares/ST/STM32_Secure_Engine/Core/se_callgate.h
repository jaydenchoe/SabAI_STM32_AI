...
#define SE_APP_GET_ACTIVE_FW_INFO                 (0x20UL)    /*!< User Application retrieves the Active 
                                                                             Firmware Info */
#define SE_APP_GET_FW_STATE                       (0x21UL)    /*!< User Application retrieves the Active Image State */
#define SE_APP_SET_FW_STATE                       (0x22UL)    /*!< User Application sets the Active Image State */
...
/* Secure Engine Interrupts managment */
...
/** @addtogroup SE_CALLGATE_Exported_Functions
  * @{
  */
SE_ErrorStatus SE_CallGate(SE_FunctionIDTypeDef eID, SE_StatusTypeDef *peSE_Status, uint32_t PrimaskValue, ...);
