...
SE_ErrorStatus SE_APP_GetActiveFwState(SE_StatusTypeDef *peSE_Status, SE_FwStateTypeDef *p_FwState);
SE_ErrorStatus SE_APP_SetActiveFwState(SE_StatusTypeDef *peSE_Status, SE_FwStateTypeDef *p_FwState);
