...
/**
  ...
  * @retval CKR_OK
  * @note   Refer to <a href=http://docs.oasis-open.org/pkcs11/pkcs11-base/v2.40/os/pkcs11-base-v2.40-os.html>
...
/**
  * @brief  Redirection of PKCS11 C_InitToken to access KMS service through Secure engine
  * @note   C_InitToken initializes a token
  * @param  slotID is the ID of the token’s slot
  * @param  pPin points to the SO’s initial PIN (which need not be null-terminated)
  * @param  ulPinLen is the length in bytes of the PIN
  * @param  pLabel points to the 32-byte label of the token
  * @retval CKR_CRYPTOKI_NOT_INITIALIZED
  * @retval CKR_DEVICE_ERROR
  * @retval CKR_DEVICE_MEMORY
  * @retval CKR_DEVICE_REMOVED
  ...
  * @retval CKR_PIN_LOCKED
  * @retval CKR_SESSION_EXISTS
  * @retval CKR_SLOT_ID_INVALID
  * @retval CKR_TOKEN_NOT_PRESENT
  * @retval CKR_TOKEN_NOT_RECOGNIZED
  ...
  *         PKCS #11 Cryptographic Token Interface Base Specification Version 2.40</a> for more details on this API
  */
#define C_InitToken( slotID, pPin, ulPinLen, pLabel )\
  SE_KMS_InitToken( slotID, pPin, ulPinLen, pLabel )
...
/**
  * @brief  Redirection of PKCS11 C_DigestKey to access KMS service through Secure engine
  * @note   C_DigestKey continues a multiple-part message-digesting operation by
  *         digesting the value of a secret key
  * @param  hSession is the session’s handle
  * @param  hKey is the handle of the secret key to be digested
  * @retval CKR_CRYPTOKI_NOT_INITIALIZED
  * @retval CKR_DEVICE_ERROR
  * @retval CKR_DEVICE_MEMORY
  * @retval CKR_DEVICE_REMOVED
  ...
  *         PKCS #11 Cryptographic Token Interface Base Specification Version 2.40</a> for more details on this API
  */
#define C_DigestKey( hSession, hKey) \
  SE_KMS_DigestKey( hSession, hKey)
