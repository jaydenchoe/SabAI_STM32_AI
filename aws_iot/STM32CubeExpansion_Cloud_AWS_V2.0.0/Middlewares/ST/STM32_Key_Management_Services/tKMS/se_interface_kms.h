...
CK_RV SE_KMS_InitToken(CK_SLOT_ID slotID,  CK_UTF8CHAR_PTR pPin,
...
CK_RV SE_KMS_DigestKey(CK_SESSION_HANDLE hSession, CK_OBJECT_HANDLE hKey);
...
CK_RV SE_KMS_ImportBlob(CK_BYTE_PTR pData, CK_ULONG_PTR pImportBlobState);
...
CK_RV SE_KMS_UnitaryTest(CK_ULONG ulTestID, CK_ULONG_PTR plNbPassed, CK_ULONG_PTR plNbFailed);
