...
#define NVMS_CFG_NUM_SLOTS                     100U
...
union nvms_data_header
{
  struct
  {
    ...
    nvms_slot_t                 slot;
    uint32_t                    instance;
    nvms_data_header_t          *next;
    nvms_data_type_t            data_type;
    size_t                      data_size;
...
/**
  ...
  * @api
  */
#define NVMS_WriteData(slot, size, data_p)                                         \
...
/*
  ...
  * @api
  */
#define NVMS_GetData(slot, size_p, key_pp)                                         \
