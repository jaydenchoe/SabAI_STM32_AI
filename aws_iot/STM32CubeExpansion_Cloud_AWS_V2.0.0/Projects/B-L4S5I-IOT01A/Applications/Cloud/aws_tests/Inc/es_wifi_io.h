...
/* Includes ------------------------------------------------------------------*/
#include "main.h" /* Global IO definitions */
...
#define WIFI_RESET_MODULE()                do{\
                                             ...
                                             HAL_Delay(10);\
                                             HAL_GPIO_WritePin(ES_WIFI_RESET_GPIO_Port, ES_WIFI_RESET_Pin, GPIO_PIN_SET);\
                                             HAL_Delay(500);\
                                             }while(0);


#define WIFI_ENABLE_NSS()                  do{ \
                                             HAL_GPIO_WritePin( ES_WIFI_NSS_GPIO_Port, ES_WIFI_NSS_Pin, GPIO_PIN_RESET );\
                                             }while(0);
...
#define WIFI_IS_CMDDATA_READY()            (HAL_GPIO_ReadPin(ES_WIFI_DATA_READY_GPIO_Port, ES_WIFI_DATA_READY_Pin) == GPIO_PIN_SET)
