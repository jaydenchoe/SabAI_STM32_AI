...
#define SPI_INTERFACE_PRIO              configLIBRARY_MAX_SYSCALL_INTERRUPT_PRIORITY
...
#define SEM_SIGNAL(a)           xSemaphoreGiveFromISR(a, NULL)
#define SEM_WAIT(a,timeout)     xSemaphoreTake(a,timeout)
#define SPI_INTERFACE_PRIO      configLIBRARY_LOWEST_INTERRUPT_PRIORITY
#else
