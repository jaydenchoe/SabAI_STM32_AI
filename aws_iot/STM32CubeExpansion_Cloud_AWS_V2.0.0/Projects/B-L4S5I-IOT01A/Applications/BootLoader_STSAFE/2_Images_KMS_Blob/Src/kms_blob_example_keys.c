...
const kms_obj_keyhead_1024_t   Test_Key_RSA_2048 =
{
  ...
  CKK_RSA,                         /*   uint32_t type;              */
  30,                              /*   uint32_t object_id;         */
  {
...
const kms_obj_keyhead_256_t   Test_Key_AES256_Derivable =
{
  KMS_ABI_VERSION_CK_2_40,         /*   uint32_t version;           */
  KMS_ABI_CONFIG_KEYHEAD,          /*   uint32_t configuration;     */
  ...
  31,                              /*   uint32_t object_id;         */
  {
    ...
    CKA_LABEL,        24, 0x52455355U, 0x424F4C42U, 0x50595243U, 0x49524544U, 0x4C424156U, 0x00000045U,      /* 'USER', 'BLOB', 'CRYP', 'DERI', 'VABL', 'E' */
