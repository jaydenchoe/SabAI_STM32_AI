...
/* +4U because __ICFEDIT_SE_CallGate_region_ROM_start__ is at 0x8000200 followed by 4 dummy bytes */
#define SE_CALLGATE_REGION_ROM_START (((uint32_t)& __ICFEDIT_SE_CallGate_region_ROM_start__) + 4U)
...
/** @defgroup SFU_CONFIG_KMS_NVM_MAPPING KMS NVM Memory Mapping
  * @{
  */
