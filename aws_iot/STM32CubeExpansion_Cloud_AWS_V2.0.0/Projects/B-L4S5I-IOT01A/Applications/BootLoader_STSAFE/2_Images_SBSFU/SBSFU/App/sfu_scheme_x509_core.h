...
/* Exported functions ------------------------------------------------------- */
SFU_ErrorStatus SFU_SCHEME_X509_CORE_Init(void);
...
SFU_ErrorStatus SFU_SCHEME_X509_CORE_HashContiguous(uint8_t* p_Buffer, uint32_t uBufferSize, 
                                                    uint8_t* p_HashBuffer, uint32_t uHashBufferSize);
