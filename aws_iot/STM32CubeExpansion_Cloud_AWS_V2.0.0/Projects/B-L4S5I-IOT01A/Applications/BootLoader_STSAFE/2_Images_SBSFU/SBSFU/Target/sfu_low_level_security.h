...
#define SFU_PROTECT_MPU_AREA_SFUEN_SIZE_0       MPU_REGION_SIZE_256KB
#define SFU_PROTECT_MPU_AREA_SFUEN_SIZE_1       MPU_REGION_SIZE_32KB
...
/**
  * KMS NVM from 0x08101000 to 0x08104FFF
  * Slot 0 from 0x08105000 to 0x081BFFFF
  *
  * Region 6 from 0x8100000 to 0x817FFFF - 512MB
  * Region 7 from 0x8180000 to 0x81BFFFF - 256 MB
  */
#define APP_PROTECT_MPU_AREA_SLOT0_START        (SFU_IMG_SLOT_0_REGION_BEGIN_VALUE / 0x80000 * 0x80000)  /* 0x8100000 */
#define APP_PROTECT_MPU_AREA_SLOT0_SIZE         MPU_REGION_SIZE_512KB
#define APP_PROTECT_MPU_AREA_SLOT0_PERM         MPU_REGION_FULL_ACCESS    /* FULL_ACCESS because of the NVMEM under Firewall */
#define APP_PROTECT_MPU_AREA_SLOT0_EXEC         MPU_INSTRUCTION_ACCESS_ENABLE
#define APP_PROTECT_MPU_AREA_SLOT0_SREG         0x00U
#define APP_PROTECT_MPU_AREA_HIDE_START         (SFU_IMG_SLOT_0_REGION_BEGIN_VALUE + SFU_IMG_SLOT_0_REGION_SIZE)
#define APP_PROTECT_MPU_AREA_HIDE_SIZE          MPU_REGION_SIZE_32KB
...
#define APP_PROTECT_MPU_AREA_HIDE_SREG          0x00U                        /*!< 32 Kbytes */

#define APP_PROTECT_MPU_AREA_EXT_START          0x8180000 /* APP_PROTECT_MPU_AREA_SLOT0_START + 512MB */
#define APP_PROTECT_MPU_AREA_EXT_SIZE           MPU_REGION_SIZE_256KB
#define APP_PROTECT_MPU_AREA_EXT_SREG           0x00U
#define APP_PROTECT_MPU_AREA_EXT_PERM           MPU_REGION_PRIV_RO
#define APP_PROTECT_MPU_AREA_EXT_EXEC           MPU_INSTRUCTION_ACCESS_ENABLE
