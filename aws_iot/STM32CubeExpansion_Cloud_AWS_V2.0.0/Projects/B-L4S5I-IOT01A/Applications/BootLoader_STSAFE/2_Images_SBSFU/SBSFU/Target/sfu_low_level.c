...
/** @defgroup  SFU_LOW_LEVEL SBSFU Low Level Interface
  * @{
  */
...
/** @defgroup SFU_LOW_LEVEL_Imported_Variables Imported Variables
  * @{
  */
...
/** @defgroup SFU_LOW_LEVEL_Private_Variables Private Variables
  * @{
  */
...
/** @defgroup SFU_LOW_LEVEL_Private_Functions Private Functions
  * @{
  */
...
/** @defgroup SFU_LOW_LEVEL_Initialization_Functions Initialization Functions
  * @{
  */
