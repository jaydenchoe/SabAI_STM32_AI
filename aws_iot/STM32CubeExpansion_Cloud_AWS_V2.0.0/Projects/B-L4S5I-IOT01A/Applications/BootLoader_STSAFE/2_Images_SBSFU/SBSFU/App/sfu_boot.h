...
#define FLOW_CTRL_RDP (FLOW_CTRL_PCROP ^ FLOW_STEP_RDP)
#define FLOW_CTRL_SEC_MEM (FLOW_CTRL_RDP ^ FLOW_STEP_SEC_MEM)
#define FLOW_CTRL_STATIC_PROTECT FLOW_CTRL_SEC_MEM
...
/**
  * @brief  SFU_BOOT Flow Control : Exported macro
  */
