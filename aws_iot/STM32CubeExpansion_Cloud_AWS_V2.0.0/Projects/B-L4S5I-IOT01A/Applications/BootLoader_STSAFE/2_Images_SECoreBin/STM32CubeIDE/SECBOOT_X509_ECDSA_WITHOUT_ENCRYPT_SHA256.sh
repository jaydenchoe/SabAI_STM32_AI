...
userAppBinary=$projectdir"/PostBuild"
...
sbsfuelf="$SecureDir/2_Images_SBSFU/STM32CubeIDE/B-L4S5I-IOT01_2_Images_SBSFU/Debug/SBSFU.elf"
fw_sign_ecckey=$SecureDir"/2_Images_SBSFU/Certs/sbsfu_fs_prv.pem"
cert_fw_leaf=$SecureDir"/2_Images_SBSFU/Certs/sbsfu_fs_crt.der"
cert_fw_inter=$SecureDir"/2_Images_SBSFU/Certs/sbsfu_i2_crt.der"
